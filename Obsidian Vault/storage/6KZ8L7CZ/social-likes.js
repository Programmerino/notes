...
!function (a) {
    ...
    var k = "social-likes", l = k + "__", m = k + "_opened", n = "https:" === location.protocol ? "https:" : "http:", o = {
        ...
        plusone: {
            counterUrl: n + "//share.yandex.ru/gpp.xml?url="+ window.location.href.replace(window.location.hash, "").split("://")[1] +"&callback=?", convertNumber: function (a) {
        ...
        fbmessenger: {
            counters: false,
            popupUrl: 'fb-messenger://share/?link={url}&app_id=130182077069283',
            popupWidth: 820,
            popupHeight: 500
        },
        sms: {
            counters: false,
            popupUrl: 'sms:?&body={title}%0A%0A{url}',
            popupWidth: 820,
            popupHeight: 500
        },
        weibo: {
            counters: false,
            popupUrl: 'http://service.weibo.com/share/share.php?url={url}&title={title}&type=button&language=zh_cn',
            popupWidth: 820,
            popupHeight: 500
        }
    }, p = {
