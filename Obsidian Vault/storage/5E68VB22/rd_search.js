...
$(document).ready(function() {
    ...
    var aryPathsToIgnore = [
        ...
        arySiteLimit = [],
        searchDomain = 'search.cdc.gov';

	// reset form action for 'in-network' dev
    //switch (document.location.host) {
    //	case 'prototyped.cdc.gov':
    //		searchDomain = 'prototyped.cdc.gov'
    //		break;
    //	case 'prototype.cdc.gov':
    //		searchDomain = 'prototype.cdc.gov'
    //		break;
    //	case 'wwwdev.cdc.gov':
    //		searchDomain = 'wwwdev.cdc.gov'
    //		break;
    //	case 'atsdr-dev.cdc.gov':
    //		searchDomain = 'wwwdev.cdc.gov'
    //		break;
    //	default:
    //		searchDomain = 'www.cdc.gov'
    //}

    strFormAction = blnSpanishPage ? window.location.protocol + '//' + searchDomain + '/search/spanish' : window.location.protocol + '//' + searchDomain + '/search';
