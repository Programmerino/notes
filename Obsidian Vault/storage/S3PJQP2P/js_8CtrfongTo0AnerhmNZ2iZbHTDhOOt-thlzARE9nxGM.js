...
function initializePlayerInstance(initVars) {
  ...
  if(initVars.playlist_id) {
    var playlistUrl = "https://cdn.jwplayer.com/v2/playlists/" + initVars.playlist_id + '?_=' + new Date().getTime();
...
function initializeSingleVideo(playerInstance, initVars) {
  playerInstance.setup({
    playlist:"https://cdn.jwplayer.com/v2/media/" + initVars.video_id + '?_=' + new Date().getTime(),
...
function setupHillTVPlayerWatchers(playerInstance, initVars) {
  ...
  playerInstance.on('playlistComplete', function(e) {
    if(initVars.playlist_id) {
      ...
      var url = "https://cdn.jwplayer.com/v2/playlists/" + initVars.playlist_id + '?_=' + new Date().getTime();
