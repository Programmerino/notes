...
if(typeof window.YNAM === "undefined" || window.YNAM == ''){
   window.YNAM = window.SID;
}
if(typeof RD_DOMAIN === "undefined" || RD_DOMAIN == ''){
    RD_DOMAIN =  "//"+ prefix +"rd.yna.co.kr/";
}

console.log("stat sid :" + window.SID);

<!--와이즈로그-->
(function(s,o,d,e,m){e=d.createElement(o);m=d.getElementsByTagName(o)[0];e.async=1;e.src=s;e.charset='utf-8';m.parentNode.insertBefore(e,m);})(RD_DOMAIN + 'common/js/ystat.js','script',document);
<!--독자피드백-->
