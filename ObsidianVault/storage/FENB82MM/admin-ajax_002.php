...
.slideshow_container_style-dark .slideshow_play {
	background: url('http://www.venturabroadcasting.com/wp-content/plugins/slideshow-jquery-image-gallery/images/SlideshowPlugin/dark-controlpanel.png') 0 0 no-repeat;
}

.slideshow_container_style-dark .slideshow_pause {
	background: url('http://www.venturabroadcasting.com/wp-content/plugins/slideshow-jquery-image-gallery/images/SlideshowPlugin/dark-controlpanel.png') -20px 0 no-repeat;
}
...
.slideshow_container_style-dark .slideshow_button {
	...
	height: 100px;
	width: 24px;
	background: url('http://www.venturabroadcasting.com/wp-content/plugins/slideshow-jquery-image-gallery/images/SlideshowPlugin/dark-arrows.png') no-repeat;
}
...
.slideshow_container_style-dark .slideshow_pagination ul li {
	...
	width: 15px;
	height: 15px;
	background: url('http://www.venturabroadcasting.com/wp-content/plugins/slideshow-jquery-image-gallery/images/SlideshowPlugin/dark-bullet.png') no-repeat;
}