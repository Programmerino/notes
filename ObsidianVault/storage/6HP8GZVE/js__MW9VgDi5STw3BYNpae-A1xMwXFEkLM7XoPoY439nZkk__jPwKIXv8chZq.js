(function ($) {
  $(document).ready(function(){
    $('#pt-social-media a').not('.email-share-button, .more-share-button, .facebook-share-button, .whatsapp-share-button').click(function(e){
      e.preventDefault();
    ...
    // open larger window for whatsapp links
    $('#pt-social-media a.whatsapp-share-button').click(function(e){
      e.preventDefault();
      var url = $(this).attr('href');
      window.open(url, 'newwindow', config='height=710, width=850, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no');
    });

    $('#pt-social-media a.more-share-button').click(function(e){
      e.preventDefault();
      $('.pt-social-media_google-plus, .pt-social-media_linkedin, .pt-social-media_whatsapp, .pt-social-media_reddit').toggle();
      if ($(this).text() == 'MORE') {
    ...
    // WhatsApp works best with URLs specific to mobile app vs desktop.
    // Switch out default mobile link with one for desktop
    if ($('body').hasClass('desktop')) {
      var desktopLink = $('.whatsapp-share-button').attr('data-desktop-url');
      $('.whatsapp-share-button').attr('href', desktopLink);
    }
