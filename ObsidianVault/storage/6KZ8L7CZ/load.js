...
if (!_tb_dis) {
    ...
    var _pmpmk = pm_ppy + '/pmk-201902003.5.js';
    var _pmasync = true;
    ...
    'sx': '//a[@itemprop="articleSection"]',
    'at': '(//div[@class="b-article"]//div[@class="b-article__refs-author"] | //meta[@name="author"]/@content)[last()]',
};

var _tb_vautop = false;

var _tb_vpx = [{
    'xpath': '//div[@class="l-dark"]//div[@class="video-player"]//div[contains(@class,"video-js")]',
    'attr': 'div'
}];/** Generated CJS end **/ 
}