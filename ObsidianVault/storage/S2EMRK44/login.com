...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.canada.com";
...
if (!janrain.settings.actionText)janrain.settings.actionText = "Sign in using your account";
...
if (typeof janrain.settings.buttonBackgroundStyle === 'undefined')janrain.settings.buttonBackgroundStyle = "white";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "hhhapmlmjikgfhhfamhf";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.canada.com";
janrain.settings.permissions = ["customizable_auth_widget_hide_attribution", "customizable_auth_widget_styling"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["facebook", "yahoo", "googleplus", "linkedin-oauth2", "twitter"];
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.canada.com";
janrain.settings.share.permissions = ["customizable_share_widget_hide_attribution", "customizable_share_widget_contact_mode", "customizable_share_widget_styling", "customizable_share_widget_email_mode"];
