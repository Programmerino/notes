...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__c",
      "vtp_value":"https:\/\/commons.dw.com\/tracking\/smarttag.js"
    },{
      "function":"__c",
      "vtp_value":"logi242"
    },{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",9],8,16],".split(\".\");return a[0]})();"]
    },{
      "function":"__remm",
      ...
      "vtp_ignoreCase":true,
      "vtp_map":["list",["map","key","m","value","Mobile"],["map","key","www","value","Desktop"],["map","key","m\\-(.*)","value","Mobile"],["map","key","www\\-(.*)","value","Desktop"]]
    },{
      "function":"__u",
      "vtp_component":"PATH",
      "vtp_enableMultiQueryKeys":false,
      ...
      "vtp_replaceAfterMatch":false,
      "vtp_ignoreCase":true,
      "vtp_map":["list",["map","key","(.*)\/s\\-[0-9]*","value","Strukturseite"],["map","key","(.*)\/a\\-[0-9]*","value","Artikelseite"],["map","key","(.*)\/av\\-[0-9]*","value","AV-Inhalt"],["map","key","(.*)\/t\\-[0-9]*","value","Themenseite"],["map","key","(.*)\/g\\-[0-9]*","value","Bildergalerie"]]
    },{
      "function":"__j",
      ...
      "vtp_replaceAfterMatch":false,
      "vtp_ignoreCase":true,
      "vtp_map":["list",["map","key","^\/de\/.*","value","Deutsch"],["map","key","^\/en\/.*","value","Englisch"],["map","key","^\/ru\/.*","value","Russisch"],["map","key","^\/zh\/.*","value","Chinesisch"],["map","key","^\/pt-br\/.*","value","Brasilianisch"],["map","key","^\/sq\/.*","value","Albanisch"],["map","key","^\/am\/.*","value","Amharisch"],["map","key","^\/ar\/.*","value","Arabisch"],["map","key","^\/bn\/.*","value","Bengali"],["map","key","^\/bs\/.*","value","Bosnisch"],["map","key","^\/bg\/.*","value","Bulgarisch"],["map","key","^\/fa-af\/.*","value","Dari"],["map","key","^\/fr\/.*","value","Französisch"],["map","key","^\/el\/.*","value","Griechisch"],["map","key","^\/ha\/.*","value","Hausa"],["map","key","^\/hi\/.*","value","Hindi"],["map","key","^\/id\/.*","value","Indonesisch"],["map","key","^\/sw\/.*","value","Swahili"],["map","key","^\/hr\/.*","value","Kroatisch"],["map","key","^\/mk\/.*","value","Mazedonisch"],["map","key","^\/ps\/.*","value","Pashto"],["map","key","^\/fa-ir\/.*","value","Persisch"],["map","key","^\/pl\/.*","value","Polnisch"],["map","key","^\/pt-002\/.*","value","Portugiesisch für Afrika"],["map","key","^\/ro\/.*","value","Rumänisch"],["map","key","^\/sr\/.*","value","Serbisch"],["map","key","^\/es\/.*","value","Spanisch"],["map","key","^\/tr\/.*","value","Türkisch"],["map","key","^\/uk\/.*","value","Ukrainisch"],["map","key","^\/ur\/.*","value","Urdu"]]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){",["escape",["macro",2],8,16],".split(\"?\");var a=",["escape",["macro",2],8,16],".split(\"\/\");return a.reverse()[0]})();"]
    },{
      "function":"__remm",
      "vtp_setDefaultValue":false,
      "vtp_input":["macro",12],
      ...
      "vtp_replaceAfterMatch":false,
      "vtp_ignoreCase":true,
      "vtp_map":["list",["map","key","^\/de\/.*","value","1"],["map","key","^\/en\/.*","value","2"],["map","key","^\/ru\/.*","value","3"],["map","key","^\/zh\/.*","value","4"],["map","key","^\/pt-br\/.*","value","5"],["map","key","^\/sq\/.*","value","6"],["map","key","^\/am\/.*","value","7"],["map","key","^\/ar\/.*","value","8"],["map","key","^\/bn\/.*","value","9"],["map","key","^\/bs\/.*","value","10"],["map","key","^\/bg\/.*","value","11"],["map","key","^\/fa-af\/.*","value","12"],["map","key","^\/fr\/.*","value","13"],["map","key","^\/el\/.*","value","14"],["map","key","^\/ha\/.*","value","15"],["map","key","^\/hi\/.*","value","16"],["map","key","^\/id\/.*","value","17"],["map","key","^\/sw\/.*","value","18"],["map","key","^\/hr\/.*","value","19"],["map","key","^\/mk\/.*","value","20"],["map","key","^\/ps\/.*","value","21"],["map","key","^\/fa-ir\/.*","value","22"],["map","key","^\/pl\/.*","value","23"],["map","key","^\/pt-002\/.*","value","24"],["map","key","^\/ro\/.*","value","25"],["map","key","^\/sr\/.*","value","27"],["map","key","^\/es\/.*","value","28"],["map","key","^\/tr\/.*","value","29"],["map","key","^\/uk\/.*","value","30"],["map","key","^\/ur\/.*","value","31"]]
    },{
      "function":"__d",
      "vtp_elementId":"navPath",
      "vtp_selectorType":"ID"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return\"Scroll ",["escape",["macro",15],7]," ",["escape",["macro",13],7],"\"})();"]
    },{
      "function":"__f",
      "vtp_component":"URL"
    },{
  ...
  "tags":[{
      ...
      "vtp_verticalThresholdsPercent":"0,10,20,30,40,50,60,70,75,80,90,100",
      "vtp_verticalThresholdOn":true,
      "vtp_triggerStartOption":"DOM_READY",
      "vtp_horizontalThresholdOn":false,
      "vtp_uniqueTriggerId":"10586544_9",
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript data-gtmsrc=\"",["escape",["macro",4],14,3],"\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\u003Cscript type=\"text\/gtmscript\"\u003Evar scroll=new ATInternet.Tracker.Tag({log:\"",["escape",["macro",5],7],"\",logSSL:\"",["escape",["macro",6],7],"\",secure:!0,site:\"",["escape",["macro",7],7],"\",domain:\"xiti.com\",cookieDomain:\".dw.com\",ignoreEmptyChapterValue:!0}),scrollDepth=\"[\"+",["escape",["macro",8],8,16],"+\"%25]\";\nscroll.publisher.send({impression:{campaignId:\"[Scroll]\",creation:scrollDepth,variant:\"[\"+encodeURIComponent(",["escape",["macro",11],8,16],")+\"]\",format:\"[\"+encodeURIComponent(",["escape",["macro",13],8,16],")+\"]\",generalPlacement:\"[\"+encodeURIComponent(",["escape",["macro",14],8,16],")+\"]\",advertiserId:\"[\"+encodeURIComponent(",["escape",["macro",15],8,16],")+\"]\",detailedPlacement:\"[\"+encodeURIComponent(",["escape",["macro",16],8,16],".split(\"-\")[1].split(\"?\")[0])+\"]\",url:\"[\"+encodeURIComponent(document.location.href.split(\"?\")[0].split(\"#\")[0])+\"]\"}});\u003C\/script\u003E"],
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(){if(jwplayer\u0026\u0026jwplayer().id)for(var b=[\"play\",\"pause\"],a=0;a\u003Cb.length;a++)jwplayer().on(b[a],function(a){var c=this.getConfig(),b={referrer:document.referrer,page_uri:document.location.href},e={playback_position_s:c.currentTime,volume:c.volume},d=this.mediaList[0];d.duration=c.duration;a=\"media_\"+a.type;_pc.sendCustomEvent(a,d.playerId,b,e,d)})})();\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":112
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,b){a={src:a,defer:!0,async:!0,onload:b};b=document.createElement(\"script\");for(c in a)b[c]=a[c];var c=b;a=document.getElementsByTagName(\"script\")[0];a.parentNode.insertBefore(c,a)})(\"\/\/peach-static.ebu.io\/peach-collector-1.x.min.js\",PeachCollectorLoaded);\nfunction PeachCollectorLoaded(){var a=location.pathname.split(\"\/\");var b=1\u003Ca.length?a[a.length-1]:null;a={lang:0\u003Ca.length?a[1]:null,type:null!=b?b.split(\"-\")[0]:null,id:null!=b?b.split(\"-\")[1]:null};b=window._pc=new PeachCollector(window);b.init(\"dedw000000000047\").enableTracking().sendPageViewEvent(null,null,null,a)};\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":119
  ...
  "predicates":[{
      ...
      "function":"_eq",
      "arg0":["macro",1],
      "arg1":"cookie__btn cookie__btn--ok"
    },{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"gtm.click"
      ...
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"https:\/\/www.dw.com\/de\/service\/empfang\/s-4136"
    },{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"gtm.dom"
...
/^(?:(?:https?|mailto):|[^&:\/?#]*(?:[\/?#]|$))/i;Sa[14]=function(a){var b=String(a);return qb.test(b)?b.replace(mb,pb):"#zSoyz"};Sa[16]=function(a){return a};var rb;
...
return null},Xc=!1;if(H.querySelectorAll)try{var Yc=H.querySelectorAll(":root");Yc&&1==Yc.length&&Yc[0]==H.documentElement&&(Xc=!0)}catch(a){}var Uc=Xc;var md={},K=null,nd=Math.random();md.s="GTM-TXHJH9T";md.Ob="7f0";md.Md="";var od={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},pd="www.googletagmanager.com/gtm.js";
var qd=pd,rd=null,sd=null,td="//www.googletagmanager.com/a?id="+md.s+"&cv=116",ud={},vd={},wd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
Z.a.j=["google"],function(){(function(a){Z.__j=a;Z.__j.b="j";Z.__j.g=!0;Z.__j.priorityOverride=0})(function(a){for(var b=String(a.vtp_name).split("."),c=U(b.shift()),d=0;d<b.length;d++)c=c&&c[b[d]];return c})}();
